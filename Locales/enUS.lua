...
L["LootUI Option Hide"] = "Hide Loot Window";
L["LootUI Option Hide Tooltip"] = "Hides the loot window, but still enables any features such as force auto loot in the background.";
